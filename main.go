...
func main() {
	...
	isProd := true       // Set to true when serving over https (false/true)
	...
	goth.UseProviders(
		...
		gplus.New(os.Getenv("GPLUS_KEY"), os.Getenv("GPLUS_SECRET"), "https://maxgoth.herokuapp.com/auth/gplus/callback"),
		...
		onedrive.New(os.Getenv("ONEDRIVE_KEY"), os.Getenv("ONEDRIVE_SECRET"), "https://maxgoth.herokuapp.com/auth/onedrive/callback"),
